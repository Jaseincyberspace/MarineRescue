...
public class TextFieldsTest {
    ...
    public void textFieldsTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.ET_currentSpeed),
                        childAtPosition(
                                ...
                                25),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("0.5"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.ET_elapsedTimeMins),
                        childAtPosition(
                                ...
                                16),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("37"), closeSoftKeyboard());
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.ET_elapsedTimeHrs), withText("5"),
